...
// const task = await reminerTask.trigger(
//   {
//     conversation_id: createReminderDto.conversation_id,
//     reminder_id: reminder._id.toString(),
//     sequence: createReminderDto.sequence,
//     message_template: createReminderDto.message_template,
//   },
//   {
//     delay: scheduledFor,
//   },
